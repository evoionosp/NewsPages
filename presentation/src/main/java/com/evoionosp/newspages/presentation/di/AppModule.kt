package com.evoionosp.newspages.presentation.di
...
import com.evoionosp.newspages.presentation.data.source.NewsDataSourceImpl
...
class AppModule {
    ...
    fun providesRetrofit(): Retrofit {
        ...
        val moshiObject = Moshi.Builder().apply {
